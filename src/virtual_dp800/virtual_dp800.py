"""Virtual Rigol DP800 series power supply control library."""
...
class dp800:
    """Virtual Rigol DP800 series power supply instrument."""
    ...
    def connect(
        ...
        #     self.reset()
        # self.set_remote()
        logger.info(f"Virtual Rigol DP800 connected!")
